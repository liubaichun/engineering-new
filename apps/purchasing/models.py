...
class PurchaseRequest(models.Model):
    ...
    applicant = models.ForeignKey(
        'finance.Employee', on_delete=models.PROTECT, related_name='purchase_requests', verbose_name='申请人'
    )
    department = models.CharField('部门', max_length=128, blank=True, default='')
    company = models.ForeignKey(
        'finance.Company', on_delete=models.PROTECT, related_name='purchase_requests', verbose_name='公司'
    )
    ...
    created_by = models.ForeignKey(
        'core.User', on_delete=models.PROTECT, related_name='purchase_requests_created', verbose_name='创建人'
    )
...
class PurchaseRequestItem(models.Model):
    ...
    request = models.ForeignKey(
        PurchaseRequest, on_delete=models.CASCADE, related_name='items', verbose_name='所属申请'
    )
    material = models.ForeignKey(
        Material, on_delete=models.PROTECT, related_name='purchase_request_items', verbose_name='物料'
    )
...
class PurchaseOrder(models.Model):
    ...
    company = models.ForeignKey(
        'finance.Company', on_delete=models.PROTECT, related_name='purchase_orders', verbose_name='公司'
    )
    project = models.ForeignKey(
        Project,
        on_delete=models.SET_NULL,
    ...
    remark = models.TextField('备注', blank=True, default='')
    created_by = models.ForeignKey(
        'core.User', on_delete=models.PROTECT, related_name='purchase_orders_created', verbose_name='创建人'
    )
    created_at = models.DateTimeField('创建时间', auto_now_add=True)
    updated_at = models.DateTimeField('更新时间', auto_now=True)
...
class PurchaseOrderItem(models.Model):
    ...
    material = models.ForeignKey(
        Material, on_delete=models.PROTECT, related_name='purchase_order_items', verbose_name='物料'
    )
...
class PurchaseReceive(models.Model):
    ...
    supplier = models.ForeignKey(
        Supplier, on_delete=models.PROTECT, related_name='purchase_receives', verbose_name='供应商'
    )
    company = models.ForeignKey(
        'finance.Company', on_delete=models.PROTECT, related_name='purchase_receives', verbose_name='公司'
    )
    ...
    received_by = models.ForeignKey(
        'finance.Employee', on_delete=models.PROTECT, related_name='purchase_receives', verbose_name='收货人'
    )
    remark = models.TextField('备注', blank=True, default='')
    created_by = models.ForeignKey(
        'core.User', on_delete=models.PROTECT, related_name='purchase_receives_created', verbose_name='创建人'
    )
    created_at = models.DateTimeField('创建时间', auto_now_add=True)
...
class PurchaseReceiveItem(models.Model):
    ...
    receive = models.ForeignKey(
        PurchaseReceive, on_delete=models.CASCADE, related_name='items', verbose_name='所属入库单'
    )
    order_item = models.ForeignKey(
        PurchaseOrderItem, on_delete=models.PROTECT, related_name='receive_items', verbose_name='订单明细'
    )
    material = models.ForeignKey(
        Material, on_delete=models.PROTECT, related_name='purchase_receive_items', verbose_name='物料'
    )
