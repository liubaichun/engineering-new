...
class RepairRequest(models.Model):
    ...
    equipment = models.ForeignKey(Equipment, on_delete=models.PROTECT, related_name='repair_requests', verbose_name='设备')
    reporter = models.ForeignKey(Employee, on_delete=models.PROTECT, related_name='repair_reports', verbose_name='报修人')
    company = models.ForeignKey('finance.Company', on_delete=models.PROTECT, related_name='repair_requests', verbose_name='公司')
    project = models.ForeignKey('tasks.Project', on_delete=models.SET_NULL, null=True, blank=True, related_name='repair_requests', verbose_name='关联项目')
    ...
    assigned_to = models.ForeignKey(Employee, on_delete=models.SET_NULL, null=True, blank=True, related_name='repair_assigned', verbose_name='维修负责人')
    ...
    created_by = models.ForeignKey('core.User', on_delete=models.PROTECT, related_name='repair_requests_created', verbose_name='创建人')
...
class RepairSparePart(models.Model):
    """维修配件记录"""
    request = models.ForeignKey(RepairRequest, on_delete=models.CASCADE, related_name='spare_parts', verbose_name='报修单')
    material = models.ForeignKey('material.Material', on_delete=models.PROTECT, related_name='repair_spare_parts', verbose_name='物料')
