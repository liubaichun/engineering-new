...
PERMISSIONS = [
    ...
    ('finance', 'bank', 'finance:bank:export', '导出银行流水'),
    ...
    ('finance', 'company', 'finance:social:manage', '管理社保配置'),
    ('finance', 'report', 'finance:report:read', '查看财务报表'),
    ('finance', 'arap', 'finance:arap:read', '查看应收应付'),
    # ── CRM ─────────────────────────────────────────────────────────────────
    ...
    ('crm', 'followup', 'crm:followup:delete', '删除跟进'),
    ('crm', 'opportunity', 'crm:opportunity:read', '查看商机'),
    ('crm', 'opportunity', 'crm:opportunity:create', '创建商机'),
    ('crm', 'opportunity', 'crm:opportunity:update', '编辑商机'),
    ('crm', 'opportunity', 'crm:opportunity:approve', '审批商机'),
    ('crm', 'opportunity', 'crm:opportunity:delete', '删除商机'),
    ('crm', 'client_source', 'crm:client_source:read', '查看客户来源'),
    ('crm', 'client_source', 'crm:client_source:update', '管理客户来源'),
    ('crm', 'supplier', 'crm:supplier:read', '查看供应商'),
    ('crm', 'supplier', 'crm:supplier:update', '管理供应商'),
    ('crm', 'contact', 'crm:contact:read', '查看联系人'),
    ('crm', 'contact', 'crm:contact:create', '创建联系人'),
    ('crm', 'contact', 'crm:contact:update', '编辑联系人'),
    ('crm', 'contact', 'crm:contact:delete', '删除联系人'),
    ('crm', 'payment_plan', 'crm:payment_plan:read', '查看付款计划'),
    ('crm', 'payment_plan', 'crm:payment_plan:update', '管理付款计划'),
    ('crm', 'contract_change_log', 'crm:contract_change_log:read', '查看合同变更'),
    ('crm', 'contract_change_log', 'crm:contract_change_log:update', '管理合同变更'),
    ('crm', 'follow_up_record', 'crm:follow_up_record:read', '查看跟进记录'),
    ('crm', 'follow_up_record', 'crm:follow_up_record:update', '管理跟进记录'),
    # ── 项目 ─────────────────────────────────────────────────────────────────
    ...
    # ── 维修 ─────────────────────────────────────────────────────────────────
    ('repair', 'repair_request', 'repair:repair_request:read', '查看维修单'),
    ('repair', 'repair_request', 'repair:repair_request:update', '管理维修单'),
    # ── 采购 ─────────────────────────────────────────────────────────────────
    ('purchasing', 'request', 'purchasing:request:read', '查看采购申请'),
    ('purchasing', 'request', 'purchasing:request:create', '创建采购申请'),
    ('purchasing', 'request', 'purchasing:request:update', '编辑采购申请'),
    ('purchasing', 'request', 'purchasing:request:approve', '审批采购申请'),
    ('purchasing', 'request', 'purchasing:request:reject', '驳回采购申请'),
    ('purchasing', 'order', 'purchasing:order:read', '查看采购订单'),
    ('purchasing', 'order', 'purchasing:order:create', '创建采购订单'),
    ('purchasing', 'order', 'purchasing:order:update', '编辑采购订单'),
    ('purchasing', 'order', 'purchasing:order:approve', '审批采购订单'),
    ('purchasing', 'order', 'purchasing:order:reject', '驳回采购订单'),
    ('purchasing', 'receive', 'purchasing:receive:read', '查看收货单'),
    ('purchasing', 'receive', 'purchasing:receive:create', '创建收货单'),
    ('purchasing', 'receive', 'purchasing:receive:update', '编辑收货单'),
    # ── 任务流 ────────────────────────────────────────────────────────────────
    ('task', 'task', 'task:task:read', '查看任务'),
    ('task', 'task', 'task:task:create', '创建任务'),
    ('task', 'task', 'task:task:update', '编辑任务'),
    ('task', 'task', 'task:task:delete', '删除任务'),
    ('task', 'flowtemplate', 'task:flowtemplate:read', '查看任务模板'),
    ('task', 'flowtemplate', 'task:flowtemplate:update', '编辑任务模板'),
    ('task', 'flownodetemplate', 'task:flownodetemplate:read', '查看节点模板'),
    ('task', 'flownodetemplate', 'task:flownodetemplate:update', '编辑节点模板'),
    ('task', 'flowtransition', 'task:flowtransition:read', '查看流转规则'),
    ('task', 'flowtransition', 'task:flowtransition:update', '编辑流转规则'),
    ('task', 'stageinstance', 'task:stageinstance:read', '查看阶段实例'),
    ('task', 'stageinstance', 'task:stageinstance:update', '编辑阶段实例'),
    ('task', 'taskstageinstance', 'task:taskstageinstance:read', '查看任务阶段'),
    ('task', 'taskstageinstance', 'task:taskstageinstance:update', '编辑任务阶段'),
    ('task', 'flowinstance', 'task:flowinstance:read', '查看流程实例'),
    ('task', 'flowinstance', 'task:flowinstance:update', '编辑流程实例'),
    # ── 文件 ─────────────────────────────────────────────────────────────────
    ('files', 'file', 'files:file:read', '查看文件'),
    ('files', 'file', 'files:file:create', '创建文件'),
    ('files', 'file', 'files:file:update', '编辑文件'),
    ('files', 'file', 'files:file:delete', '删除文件'),
    ('files', 'file', 'files:file:upload', '上传文件'),
    ('files', 'file', 'files:file:download', '下载文件'),
    ('files', 'category', 'files:category:read', '查看文件分类'),
    ('files', 'category', 'files:category:manage', '管理文件分类'),
    # ── 通知 ─────────────────────────────────────────────────────────────────
    ('notifications', 'channel', 'notifications:channel:read', '查看通知渠道'),
    ('notifications', 'channel', 'notifications:channel:create', '创建通知渠道'),
    ('notifications', 'channel', 'notifications:channel:update', '编辑通知渠道'),
    ('notifications', 'channel', 'notifications:channel:delete', '删除通知渠道'),
    ('notifications', 'binding', 'notifications:binding:read', '查看渠道绑定'),
    ('notifications', 'binding', 'notifications:binding:manage', '管理渠道绑定'),
    ('notifications', 'binding', 'notifications:send', '发送通知'),
    # ── 系统 ─────────────────────────────────────────────────────────────────
...
ROLE_PERMISSIONS = {
    'admin': [p[2] for p in PERMISSIONS],  # 管理员拥有全部权限（由 PERMISSIONS 列表决定）
    'finance': [
