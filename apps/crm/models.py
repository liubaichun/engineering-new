...
class Supplier(models.Model):
    ...
    counterparty_type = models.CharField(
        max_length=20, choices=COUNTERPARTY_TYPE_CHOICES, default='enterprise', blank=True, verbose_name='对方类型'
    )
...
class Client(models.Model):
    ...
    source = models.ForeignKey(
        ClientSource, verbose_name='客户来源', on_delete=models.SET_NULL, blank=True, null=True, related_name='clients'
    )
...
class Contract(models.Model):
    ...
    counterparty_type = models.CharField('对方类型', max_length=20, choices=COUNTERPARTY_TYPE_CHOICES, default='client')
    client = models.ForeignKey(
        Client, on_delete=models.PROTECT, related_name='contracts', verbose_name='客户', null=True, blank=True
    )
    supplier = models.ForeignKey(
        Supplier, on_delete=models.PROTECT, related_name='contracts', verbose_name='供应商', null=True, blank=True
    )
    ...
    updated_at = models.DateTimeField('更新时间', auto_now=True)
    created_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name='created_contracts'
    )
...
class PaymentPlan(models.Model):
    ...
    contract = models.ForeignKey(
        Contract, on_delete=models.CASCADE, related_name='payment_plans', verbose_name='关联合同'
    )
...
class ContractChangeLog(models.Model):
    ...
    contract = models.ForeignKey(
        Contract, on_delete=models.CASCADE, related_name='change_logs', verbose_name='关联合同'
    )
...
class Contact(models.Model):
    ...
    client = models.ForeignKey(
        Client, on_delete=models.PROTECT, related_name='contacts', verbose_name='所属客户', null=True, blank=True
    )
...
class FollowUpRecord(models.Model):
    ...
    contact = models.ForeignKey(
        Contact, on_delete=models.CASCADE, related_name='follow_ups', verbose_name='关联联系人', null=True, blank=True
    )
    client = models.ForeignKey(
        Client, on_delete=models.CASCADE, related_name='follow_ups', verbose_name='所属客户', null=True, blank=True
    )
    ...
    updated_at = models.DateTimeField('更新时间', auto_now=True)
    created_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name='created_followups'
    )
...
class Opportunity(models.Model):
    ...
    client = models.ForeignKey(
        Client, on_delete=models.PROTECT, related_name='opportunities', verbose_name='客户', null=True, blank=True
    )
    contact = models.ForeignKey(
    ...
    def save(self, *args, **kwargs):
        # 根据阶段自动更新概率
        stage_probabilities = {'lead': 10, 'qualify': 30, 'proposal': 50, 'negotiation': 80, 'won': 100, 'lost': 0}
