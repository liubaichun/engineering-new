...
class Account(models.Model):
    ...
    code = models.CharField('科目编码', max_length=20, help_text='如 4001-01（一级-二级）')
    name = models.CharField('科目名称', max_length=100)
    account_type = models.CharField('科目类型', max_length=20, choices=ACCOUNT_TYPES)
    level = models.IntegerField('层级', default=1, help_text='1=一级科目，2=二级科目')
    parent = models.ForeignKey(
        'self', verbose_name='父科目', on_delete=models.CASCADE, null=True, blank=True, related_name='children'
    )
