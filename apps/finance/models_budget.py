...
class Budget(models.Model):
    ...
    company = models.ForeignKey('Company', verbose_name='公司', on_delete=models.PROTECT, related_name='budgets')
    year = models.IntegerField('年份')
    month = models.IntegerField('月份', null=True, blank=True, help_text='留空表示全年预算；填写表示月度预算')
    expense_type = models.CharField('费用类型', max_length=30, choices=BUDGET_EXPENSE_TYPES)
