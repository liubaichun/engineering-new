...
class Project(models.Model):
    ...
    owner = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name='owned_projects', verbose_name='负责人'
    )
    ...
    progress = models.DecimalField(
        verbose_name='进度%', max_digits=5, decimal_places=2, default=0, help_text='项目完成进度，0-100'
    )
    budget = models.DecimalField(
        verbose_name='预算', max_digits=14, decimal_places=2, null=True, blank=True, help_text='项目预算金额'
    )
...
class Task(models.Model):
    ...
    project = models.ForeignKey(
        Project, on_delete=models.CASCADE, related_name='tasks', verbose_name='所属项目', null=True, blank=True
    )
    ...
    assignee = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name='assigned_tasks', verbose_name='处理人'
    )
    reporter = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name='reported_tasks', verbose_name='报告人'
    )
...
class TaskStageInstance(models.Model):
    ...
    task = models.ForeignKey(Task, on_delete=models.CASCADE, related_name='stage_instances', verbose_name='所属任务')
    node_template = models.ForeignKey(
        FlowNodeTemplate, on_delete=models.CASCADE, related_name='stage_instances', verbose_name='节点模板'
    )
    status = models.CharField(verbose_name='状态', max_length=20, choices=STATUS_CHOICES, default='pending')
    assignee = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name='stage_assignments', verbose_name='处理人'
    )
...
class TaskFlowInstance(models.Model):
    ...
    task = models.OneToOneField(Task, on_delete=models.CASCADE, related_name='flow_instance', verbose_name='所属任务')
    template = models.ForeignKey(
        FlowTemplate, on_delete=models.SET_NULL, null=True, related_name='instances', verbose_name='流程模板'
    )
    ...
    started_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name='started_flows', verbose_name='启动人'
    )
...
class StageActivity(models.Model):
    ...
    stage_instance = models.ForeignKey(
        TaskStageInstance, on_delete=models.CASCADE, related_name='activities', verbose_name='阶段实例'
    )
    action = models.CharField(verbose_name='动作', max_length=20, choices=ACTION_CHOICES)
    actor = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, related_name='stage_actions', verbose_name='操作人'
    )
...
class FlowTransition(models.Model):
    ...
    task = models.ForeignKey(Task, on_delete=models.CASCADE, related_name='transitions', verbose_name='所属任务')
    ...
    actor = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, related_name='flow_transitions', verbose_name='操作人'
    )
...
class TaskComment(models.Model):
    ...
    author = models.ForeignKey(
        'core.User', on_delete=models.SET_NULL, null=True, related_name='task_comments', verbose_name='评论人'
    )
...
class TaskAttachment(models.Model):
    ...
    task = models.ForeignKey(Task, on_delete=models.CASCADE, related_name='attachments', verbose_name='所属任务')
    ...
    uploaded_by = models.ForeignKey(
        'core.User', on_delete=models.SET_NULL, null=True, related_name='task_attachments', verbose_name='上传人'
    )
    company_id = models.PositiveIntegerField(
        verbose_name='所属公司', null=True, blank=True, db_index=True, help_text='所属公司ID，用于多租户隔离'
    )
...
class TaskDependency(models.Model):
    ...
    task = models.ForeignKey(Task, on_delete=models.CASCADE, related_name='dependencies_from', verbose_name='任务')
    depends_on = models.ForeignKey(
        Task, on_delete=models.CASCADE, related_name='dependencies_to', verbose_name='前置依赖任务'
    )
    dependency_type = models.CharField(
        verbose_name='依赖类型', max_length=20, choices=DEPENDENCY_TYPES, default='depends_on'
    )
    company_id = models.PositiveIntegerField(
        verbose_name='所属公司', null=True, blank=True, db_index=True, help_text='所属公司ID，用于多租户隔离'
    )
